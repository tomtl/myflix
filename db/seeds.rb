...
southpark = Video.create(title: "Southpark", description: "Colorado town of crazy kids", category: comedies,
              small_cover_url: "/tmp/south_park.jpg", large_cover_url: "/tmp/south_park.jpg")
futurama = Video.create(title: "Futurama", description: "Fry discovers the future", category: action,
              small_cover_url: "/tmp/futurama.jpg", large_cover_url: "/tmp/futurama.jpg")
monk = Video.create(title: "Monk", description: "Crazy unorthadox detective gets results", category: dramas,
              small_cover_url: "/tmp/monk.jpg", large_cover_url: "/tmp/monk_large.jpg")
family_guy = Video.create(title: "Family Guy", description: "Sick, twisted, and politically incorrect, the animated series features the adventures of the Griffin family",
