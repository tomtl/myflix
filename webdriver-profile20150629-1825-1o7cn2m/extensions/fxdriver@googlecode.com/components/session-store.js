...
goog.string.compareVersions = function(a, b) {
  for (var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0;0 == c && g < f;g++) {
    var h = d[g] || "", l = e[g] || "", q = RegExp("(\\d*)(\\D*)", "g"), r = RegExp("(\\d*)(\\D*)", "g");
    do {
      var k = q.exec(h) || ["", "", ""], p = r.exec(l) || ["", "", ""];
...
goog.math.longestCommonSubsequence = function(a, b, c, d) {
  ...
  for (var q = [], h = e, l = f;0 < h && 0 < l;) {
    c(a[h - 1], b[l - 1]) ? (q.unshift(d(h - 1, l - 1)), h--, l--) : g[h - 1][l] > g[h][l - 1] ? h-- : l--;
  }
  return q;
};
...
goog.debug.catchErrors = function(a, b, c) {
  ...
  c.onerror = function(b, c, h, l, q) {
    d && d(b, c, h, l, q);
    a({message:b, fileName:c, line:h, col:l, error:q});
    return e;
  };
};
...
wgxpath.Step.Axis = {ANCESTOR:wgxpath.Step.createAxis_("ancestor", function(a, b) {
  ...
  for (var g = 1, h = f.length;g < h;g++) {
    ...
    for (var q = 0, r = l.length;q < r;q++) {
      b = l[q], wgxpath.Node.attrMatches(b, c, d) && a.matches(b) && e.add(b), e = wgxpath.Node.getDescendantNodes(a, b, c, d, e);
    }
  }
  return e;
  ...
  try {
    ...
    if (!goog.userAgent.IE || goog.userAgent.isDocumentModeOrHigher(9)) {
      for (var f = {}, g = d.getElementsByTagName("*"), h = 0;h < g.length;++h) {
        var l = g[h], q = l.namespaceURI;
        if (!f[q]) {
          var r = l.lookupPrefix(q);
          if (!r) {
            var k = q.match(".*/(\\w+)/?$"), r = k ? k[1] : "xhtml"
          }
          f[q] = r;
        }
      }
...
bot.dom.getOverflowState = function(a, b) {
  ...
  for (var f = bot.dom.getClientRegion(a, b), g = goog.dom.getOwnerDocument(a), h = g.documentElement, l = g.body, q = bot.dom.getEffectiveStyle(h, "overflow"), r, k = c(a);k;k = c(k)) {
    var p = d(k);
    if ("visible" != p.x || "visible" != p.y) {
      ...
      if (m && "hidden" == p.x || t && "hidden" == p.y) {
        return bot.dom.OverflowState.HIDDEN;
      }
      if (m && "visible" != p.x || t && "visible" != p.y) {
        m = e(k);
        t = f.bottom < n.top - m.y;
        if (f.right < n.left - m.x && "visible" != p.x || t && "visible" != p.x) {
          return bot.dom.OverflowState.HIDDEN;
        }
      ...
      if (m && "visible" != p.x || n && "visible" != p.y) {
        if (r && (p = e(k), f.left >= h.scrollWidth - p.x || f.right >= h.scrollHeight - p.y)) {
          return bot.dom.OverflowState.HIDDEN;
        }
        f = bot.dom.getOverflowState(k);
        return f == bot.dom.OverflowState.HIDDEN ? bot.dom.OverflowState.HIDDEN : bot.dom.OverflowState.SCROLL;
...
bot.dom.getClientRect = function(a) {
  function b(a) {
    ...
    if (c) {
      var d = parseFloat(c[1]), e = parseFloat(c[2]), r = parseFloat(c[3]), k = parseFloat(c[4]), p = parseFloat(c[5]), c = parseFloat(c[6]), n = f.left + f.width, m = f.top + f.height, t = f.left * d, d = n * d, u = f.left * e, e = n * e, v = f.top * r, r = m * r, w = f.top * k, n = m * k, m = t + v + p, k = u + w + c, v = d + v + p, w = e + w + c, t = t + r + p, u = u + n + c, p = d + r + p, c = e + n + c;
      f.left = Math.min(m, v, t, p);
...
bot.dom.appendVisibleTextLinesFromElement_ = function(a, b) {
  if (bot.dom.isElement(a, goog.dom.TagName.BR)) {
    ...
    var h = bot.dom.isShown(a), l = null, q = null;
    h && (l = bot.dom.getEffectiveStyle(a, "white-space"), q = bot.dom.getEffectiveStyle(a, "text-transform"));
    goog.array.forEach(a.childNodes, function(a) {
      a.nodeType == goog.dom.NodeType.TEXT && h ? bot.dom.appendVisibleTextLinesFromTextNode_(a, b, l, q) : bot.dom.isElement(a) && bot.dom.appendVisibleTextLinesFromElement_(a, b);
    });
    f = goog.array.peek(b) || "";
...
Utils.type = function(a, b, c, d, e, f, g) {
  ...
  var h = Utils.getNativeKeyboard(), l = Utils.getNodeForNativeEvents(b), q = Components.classes["@mozilla.org/thread-manager;1"];
  if (d && h && l && q) {
    ...
    Utils.shiftCount = 0;
    for (var q = c.toUpperCase(), r = 0;r < c.length;r++) {
      var k = c.charAt(r);
      if ("\ue000" == k) {
        ...
        if (p) {
          ...
          t = Utils.keyEvent(a, b, "keydown", m, 0, e, p || h, l, d, !1);
          Utils.keyEvent(a, b, "keypress", k, n, e, p || h, l, d, !t);
...
Utils.keyEvent = function(a, b, c, d, e, f, g, h, l, q) {
  ...
  var r = 0;
  f && (r += a.MODIFIER_CONTROL);
  h && (r += a.MODIFIER_ALT);
  g && (r += a.MODIFIER_SHIFT);
  l && (r += a.MODIFIER_META);
  f = 0;
  q && (f += a.KEY_FLAG_PREVENT_DEFAULT);
  return a.sendKeyEvent(c, d, e, r, f);
};
