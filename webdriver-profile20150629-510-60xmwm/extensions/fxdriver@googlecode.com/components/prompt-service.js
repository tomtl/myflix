...
DrivenPromptService.prototype.confirmEx = function(a, b, c, d, e, f, g, h, l) {
  fxdriver.modals.signalOpenModal(a, c);
  return this.delegate_.QueryInterface(CI.nsIPromptService2).confirmEx(a, b, c, d, e, f, g, h, l);
};
