...
goog.string.compareVersions = function(a, b) {
  for (var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0;0 == c && g < f;g++) {
    var h = d[g] || "", l = e[g] || "", r = RegExp("(\\d*)(\\D*)", "g"), p = RegExp("(\\d*)(\\D*)", "g");
    do {
      var k = r.exec(h) || ["", "", ""], q = p.exec(l) || ["", "", ""];
  ...
  try {
    ...
    if (!goog.userAgent.IE || goog.userAgent.isDocumentModeOrHigher(9)) {
      for (var f = {}, g = d.getElementsByTagName("*"), h = 0;h < g.length;++h) {
        var l = g[h], r = l.namespaceURI;
        if (!f[r]) {
          var p = l.lookupPrefix(r);
          if (!p) {
            var k = r.match(".*/(\\w+)/?$"), p = k ? k[1] : "xhtml"
          }
          f[r] = p;
        }
      }
...
bot.dom.getOverflowState = function(a, b) {
  ...
  for (var f = bot.dom.getClientRegion(a, b), g = goog.dom.getOwnerDocument(a), h = g.documentElement, l = g.body, r = bot.dom.getEffectiveStyle(h, "overflow"), p, k = c(a);k;k = c(k)) {
    var q = d(k);
    if ("visible" != q.x || "visible" != q.y) {
      ...
      if (m && "visible" != q.x || n && "visible" != q.y) {
        if (p && (q = e(k), f.left >= h.scrollWidth - q.x || f.right >= h.scrollHeight - q.y)) {
          return bot.dom.OverflowState.HIDDEN;
        }
        f = bot.dom.getOverflowState(k);
        return f == bot.dom.OverflowState.HIDDEN ? bot.dom.OverflowState.HIDDEN : bot.dom.OverflowState.SCROLL;
...
bot.dom.getClientRect = function(a) {
  function b(a) {
    ...
    if (c) {
      var d = parseFloat(c[1]), e = parseFloat(c[2]), p = parseFloat(c[3]), k = parseFloat(c[4]), q = parseFloat(c[5]), c = parseFloat(c[6]), n = f.left + f.width, m = f.top + f.height, t = f.left * d, d = n * d, u = f.left * e, e = n * e, v = f.top * p, p = m * p, w = f.top * k, n = m * k, m = t + v + q, k = u + w + c, v = d + v + q, w = e + w + c, t = t + p + q, u = u + n + c, q = d + p + q, c = e + n + c;
      f.left = Math.min(m, v, t, q);
      f.top = Math.min(k, w, u, c);
      q = Math.max(m, v, t, q);
      c = Math.max(k, w, u, c);
      f.width = q - f.left;
      f.height = c - f.top;
...
Utils.type = function(a, b, c, d, e, f, g) {
  ...
  if (d && h && l && r) {
    ...
    Utils.shiftCount = 0;
    for (var r = c.toUpperCase(), p = 0;p < c.length;p++) {
      var k = c.charAt(p);
      if ("\ue000" == k) {
        ...
        "\ue008" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_SHIFT, q = (h = !h) ? "keydown" : "keyup") : "\ue009" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_CONTROL, q = (e = !e) ? "keydown" : "keyup") : "\ue00a" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_ALT, q = (l = !l) ? "keydown" : "keyup") : "\ue03d" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_META, q = (d = !d) ? "keydown" : "keyup") : "\ue00b" == k ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_PAUSE : 
        ...
        if (q) {
          Utils.keyEvent(a, b, q, m, 0, e, h, l, d, !1);
        } else {
          q = !1;
          n && (q = /[A-Z\!\$\^\*\(\)\+\{\}\:\?\|~@#%&_"<>]/.test(k));
          q && !h && (k = Components.interfaces.nsIDOMKeyEvent.DOM_VK_SHIFT, Utils.keyEvent(a, b, "keydown", k, 0, e, !0, l, d, !1), Utils.shiftCount += 1);
          k = m;
          if (32 <= n && 127 > n && (k = 0, !q && h && 32 < n)) {
            if (97 <= n && 122 >= n) {
              n = n + 65 - 97;
            } else {
          ...
          t = Utils.keyEvent(a, b, "keydown", m, 0, e, q || h, l, d, !1);
          Utils.keyEvent(a, b, "keypress", k, n, e, q || h, l, d, !t);
          Utils.keyEvent(a, b, "keyup", m, 0, e, q || h, l, d, !1);
          q && !h && (k = Components.interfaces.nsIDOMKeyEvent.DOM_VK_SHIFT, Utils.keyEvent(a, b, "keyup", k, 0, e, !1, l, d, !1));
        }
      }
    }
...
bot.events.TouchEventFactory_.prototype.create = function(a, b) {
  ...
  var f = goog.dom.getOwnerDocument(a), g = goog.dom.getWindow(f), h = e(b.changedTouches), l = b.touches == b.changedTouches ? h : e(b.touches), r = b.targetTouches == b.changedTouches ? h : e(b.targetTouches), p;
  bot.events.BROKEN_TOUCH_API_ ? (p = f.createEvent("MouseEvents"), p.initMouseEvent(this.type_, this.bubbles_, this.cancelable_, g, 1, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, 0, b.relatedTarget), p.touches = l, p.targetTouches = r, p.changedTouches = h, p.scale = b.scale, p.rotation = b.rotation) : (p = f.createEvent("TouchEvent"), goog.userAgent.product.ANDROID ? p.initTouchEvent(l, r, h, this.type_, g, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, 
  b.metaKey) : p.initTouchEvent(this.type_, this.bubbles_, this.cancelable_, g, 1, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, l, r, h, b.scale, b.rotation), p.relatedTarget = b.relatedTarget);
  return p;
};
...
bot.action.drag = function(a, b, c, d, e, f) {
  ...
  for (var h = 1;h <= d;h++) {
    var l = Math.floor(h * b / d), r = Math.floor(h * c / d), p = bot.dom.getClientRect(a), l = new goog.math.Coordinate(e.x + g.left + l - p.left, e.y + g.top + r - p.top);
    f.move(a, l);
  }
  f.releaseButton();
};
...
SyntheticMouse.prototype.move = function(a, b, c) {
  goog.log.info(SyntheticMouse.LOG_, "SyntheticMouse.move " + a + " " + b + " " + c);
  b = b || 0;
  c = c || 0;
  var d;
  if (a) {
    if (a.nodeType == goog.dom.NodeType.ELEMENT) {
      ...
      if (this.lastElement) {
        var e;
        try {
          goog.dom.getOwnerDocument(this.lastElement), e = !0;
        } catch (f) {
          e = !1;
        }
        e && (d = this.lastElement, b = this.lastMousePosition.x + b, c = this.lastMousePosition.y + c);
      }
      d || (d = Utils.getMainDocumentElement(a), a = goog.style.getClientPosition(d), b -= a.x, c -= a.y);
    }
  }
  e = goog.dom.getOwnerDocument(d);
  bot.setWindow(goog.dom.getWindow(e));
  var g = a = 0;
  this.isButtonPressed && (e = goog.dom.getDomHelper(e).getDocumentScroll(), a = 2 * (e.x - this.viewPortOffset.x), g = 2 * (e.y - this.viewPortOffset.y), goog.log.info(SyntheticMouse.LOG_, "xCompensate = " + a + " yCompensate = " + g));
  b = new goog.math.Coordinate(b + a, c + g);
  goog.log.info(SyntheticMouse.LOG_, "Calling mouse.move with: " + b.x + ", " + b.y + ", " + d);
...
SyntheticMouse.prototype.click = function(a) {
  goog.log.info(SyntheticMouse.LOG_, "SyntheticMouse.click " + a);
  ...
  goog.log.info(SyntheticMouse.LOG_, "About to do a bot.action.click on " + a);
  ...
  bot.action.click(a, this.lastMousePosition, new bot.Mouse(null, b));
  bot.dom.isEditable(a) && void 0 !== a.value && goog.dom.selection.setCursorPosition(a, a.value.length);
  this.lastElement = a;
  return SyntheticMouse.newResponse(bot.ErrorCode.SUCCESS, "ok");
};
SyntheticMouse.prototype.contextClick = function(a) {
  goog.log.info(SyntheticMouse.LOG_, "SyntheticMouse.contextClick " + a);
  a = a ? a : this.lastElement;
  var b = this.isElementShown(a);
  if (b) {
    return b;
  }
  goog.log.info(SyntheticMouse.LOG_, "About to do a bot.action.rightClick on " + a);
  bot.action.rightClick(a, this.lastMousePosition);
  this.lastElement = a;
  return SyntheticMouse.newResponse(bot.ErrorCode.SUCCESS, "ok");
};
SyntheticMouse.prototype.doubleClick = function(a) {
  goog.log.info(SyntheticMouse.LOG_, "SyntheticMouse.doubleClick " + a);
  a = a ? a : this.lastElement;
  var b = this.isElementShown(a);
  if (b) {
    return b;
  }
  goog.log.info(SyntheticMouse.LOG_, "About to do a bot.action.doubleClick on " + a);
  bot.action.doubleClick(a, this.lastMousePosition);
  this.lastElement = a;
  return SyntheticMouse.newResponse(bot.ErrorCode.SUCCESS, "ok");
};
SyntheticMouse.prototype.down = function(a) {
  goog.log.info(SyntheticMouse.LOG_, "SyntheticMouse.down " + a);
...
SyntheticMouse.prototype.up = function(a) {
  goog.log.info(SyntheticMouse.LOG_, "SyntheticMouse.up " + a);
  a = this.getElement_(a);
...
SyntheticMouse.EventEmitter.prototype.fireMouseEvent = function(a, b, c) {
  goog.log.info(SyntheticMouse.LOG_, "Calling fireMouseEvent " + b + " " + c.clientX + ", " + c.clientY + ", " + a);
  if ("click" == b) {
    return!0;
  }
  var d = goog.dom.getOwnerDocument(a), d = goog.dom.getWindow(d), d = this._getDOMWindowUtils(d), e = this._parseModifiers(c);
  d.sendMouseEventToWindow ? d.sendMouseEventToWindow(b, Math.round(c.clientX), Math.round(c.clientY), c.button, 1, e) : d.sendMouseEvent(b, Math.round(c.clientX), Math.round(c.clientY), c.button, 1, e);
  goog.log.info(SyntheticMouse.LOG_, "Called fireMouseEvent " + b + " " + c.clientX + ", " + c.clientY + ", " + a);
  return!0;
};
