...
goog.string.compareVersions = function(a, b) {
  for (var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0;0 == c && g < f;g++) {
    var h = d[g] || "", k = e[g] || "", q = /(\d*)(\D*)/g, p = /(\d*)(\D*)/g;
    do {
      var l = q.exec(h) || ["", "", ""], r = p.exec(k) || ["", "", ""];
      if (0 == l[0].length && 0 == r[0].length) {
        break;
      }
      var c = 0 == l[1].length ? 0 : parseInt(l[1], 10), n = 0 == r[1].length ? 0 : parseInt(r[1], 10), c = goog.string.compareElements_(c, n) || goog.string.compareElements_(0 == l[2].length, 0 == r[2].length) || goog.string.compareElements_(l[2], r[2]);
    } while (0 == c);
  }
  return c;
};
...
goog.math.longestCommonSubsequence = function(a, b, c, d) {
  ...
  for (var q = [], h = e, k = f;0 < h && 0 < k;) {
    c(a[h - 1], b[k - 1]) ? (q.unshift(d(h - 1, k - 1)), h--, k--) : g[h - 1][k] > g[h][k - 1] ? h-- : k--;
  }
  return q;
};
...
goog.debug.catchErrors = function(a, b, c) {
  ...
  c.onerror = function(b, c, h, k, q) {
    d && d(b, c, h, k, q);
    a({message:b, fileName:c, line:h, col:k, error:q});
    return e;
  };
};
...
fxdriver.moz.markUnwrapped_ = function(a) {
  Object.defineProperty(a, "__fxdriver_unwrapped", {enumerable:!1, configurable:!1, writable:!0, value:!0});
};
...
WebLoadingListener.removeListener = function(a, b) {
  a.removeProgressListener && a.removeProgressListener(b.handler);
};
...
wgxpath.Step.Axis = {ANCESTOR:wgxpath.Step.createAxis_("ancestor", function(a, b) {
  ...
  for (var g = 1, h = f.length;g < h;g++) {
    ...
    for (var q = 0, p = k.length;q < p;q++) {
      b = k[q], wgxpath.Node.attrMatches(b, c, d) && a.matches(b) && e.add(b), e = wgxpath.Node.getDescendantNodes(a, b, c, d, e);
    }
  }
  return e;
  ...
  try {
    ...
    if (!goog.userAgent.IE || goog.userAgent.isDocumentModeOrHigher(9)) {
      for (var f = {}, g = d.getElementsByTagName("*"), h = 0;h < g.length;++h) {
        var k = g[h], q = k.namespaceURI;
        if (!f[q]) {
          var p = k.lookupPrefix(q);
          if (!p) {
            var l = q.match(".*/(\\w+)/?$"), p = l ? l[1] : "xhtml"
          }
          f[q] = p;
        }
      }
...
bot.dom.isShown = function(a, b) {
  ...
  if (f = bot.dom.maybeFindImageMap_(a)) {
    return!!f.image && 0 < f.rect.width && 0 < f.rect.height && bot.dom.isShown(f.image, b);
  }
...
bot.dom.getOverflowState = function(a, b) {
  ...
  for (var f = bot.dom.getClientRegion(a, b), g = goog.dom.getOwnerDocument(a), h = g.documentElement, k = g.body, q = bot.dom.getEffectiveStyle(h, "overflow"), p, l = c(a);l;l = c(l)) {
    var r = d(l);
    if ("visible" != r.x || "visible" != r.y) {
      var n = bot.dom.getClientRect(l);
      if (0 == n.width || 0 == n.height) {
        return bot.dom.OverflowState.HIDDEN;
      }
      var m = f.right < n.left, t = f.bottom < n.top;
      if (m && "hidden" == r.x || t && "hidden" == r.y) {
        return bot.dom.OverflowState.HIDDEN;
      }
      if (m && "visible" != r.x || t && "visible" != r.y) {
        m = e(l);
        t = f.bottom < n.top - m.y;
        if (f.right < n.left - m.x && "visible" != r.x || t && "visible" != r.x) {
          return bot.dom.OverflowState.HIDDEN;
        }
        f = bot.dom.getOverflowState(l);
      ...
      if (m && "hidden" == r.x || n && "hidden" == r.y) {
        return bot.dom.OverflowState.HIDDEN;
      }
      if (m && "visible" != r.x || n && "visible" != r.y) {
        if (p && (r = e(l), f.left >= h.scrollWidth - r.x || f.right >= h.scrollHeight - r.y)) {
          return bot.dom.OverflowState.HIDDEN;
        }
        f = bot.dom.getOverflowState(l);
        return f == bot.dom.OverflowState.HIDDEN ? bot.dom.OverflowState.HIDDEN : bot.dom.OverflowState.SCROLL;
...
bot.dom.getClientRect = function(a) {
  function b(a) {
    ...
    if (c) {
      var d = parseFloat(c[1]), e = parseFloat(c[2]), p = parseFloat(c[3]), l = parseFloat(c[4]), r = parseFloat(c[5]), c = parseFloat(c[6]), n = f.left + f.width, m = f.top + f.height, t = f.left * d, d = n * d, u = f.left * e, e = n * e, v = f.top * p, p = m * p, w = f.top * l, n = m * l, m = t + v + r, l = u + w + c, v = d + v + r, w = e + w + c, t = t + p + r, u = u + n + c, r = d + p + r, c = e + n + c;
      f.left = Math.min(m, v, t, r);
      f.top = Math.min(l, w, u, c);
      r = Math.max(m, v, t, r);
      c = Math.max(l, w, u, c);
      f.width = r - f.left;
      f.height = c - f.top;
...
bot.dom.appendVisibleTextLinesFromElement_ = function(a, b) {
  if (bot.dom.isElement(a, goog.dom.TagName.BR)) {
    ...
    var h = bot.dom.isShown(a), k = null, q = null;
    h && (k = bot.dom.getEffectiveStyle(a, "white-space"), q = bot.dom.getEffectiveStyle(a, "text-transform"));
    goog.array.forEach(a.childNodes, function(a) {
      a.nodeType == goog.dom.NodeType.TEXT && h ? bot.dom.appendVisibleTextLinesFromTextNode_(a, b, k, q) : bot.dom.isElement(a) && bot.dom.appendVisibleTextLinesFromElement_(a, b);
    });
    f = goog.array.peek(b) || "";
...
Utils.type = function(a, b, c, d, e, f, g) {
  ...
  var h = Utils.getNativeKeyboard(), k = Utils.getNodeForNativeEvents(b), q = Components.classes["@mozilla.org/thread-manager;1"];
  if (d && h && k && q) {
    ...
    Utils.shiftCount = 0;
    for (var q = c.toUpperCase(), p = 0;p < c.length;p++) {
      var l = c.charAt(p);
      if ("\ue000" == l) {
        ...
        "\ue00c" == l ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_ESCAPE : "\ue00d" == l ? m = n = 32 : "\ue00e" == l ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_PAGE_UP : "\ue00f" == l ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_PAGE_DOWN : "\ue010" == l ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_END : "\ue011" == l ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_HOME : "\ue012" == l ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_LEFT : "\ue013" == l ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_UP : 
        "\ue014" == l ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_RIGHT : "\ue015" == l ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_DOWN : "\ue016" == l ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_INSERT : "\ue017" == l ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_DELETE : "\ue018" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_SEMICOLON, n = 59) : "\ue019" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_EQUALS, n = 61) : "\ue01a" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD0, 
        n = 48) : "\ue01b" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD1, n = 49) : "\ue01c" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD2, n = 50) : "\ue01d" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD3, n = 51) : "\ue01e" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD4, n = 52) : "\ue01f" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD5, n = 53) : "\ue020" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD6, 
        n = 54) : "\ue021" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD7, n = 55) : "\ue022" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD8, n = 56) : "\ue023" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD9, n = 57) : "\ue024" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_MULTIPLY, n = 42) : "\ue025" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_ADD, n = 43) : "\ue026" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_SEPARATOR, 
        n = 44) : "\ue027" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_SUBTRACT, n = 45) : "\ue028" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_DECIMAL, n = 46) : "\ue029" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_DIVIDE, n = 47) : "\ue031" == l ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_F1 : "\ue032" == l ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_F2 : "\ue033" == l ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_F3 : "\ue034" == l ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_F4 : 
        ...
        l ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_F12 : "," == l || "<" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_COMMA, n = l.charCodeAt(0)) : "." == l || ">" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_PERIOD, n = l.charCodeAt(0)) : "/" == l || "?" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_SLASH, n = c.charCodeAt(p)) : "`" == l || "~" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_BACK_QUOTE, n = l.charCodeAt(0)) : "{" == l || "[" == l ? 
        (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_OPEN_BRACKET, n = l.charCodeAt(0)) : "\\" == l || "|" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_BACK_SLASH, n = l.charCodeAt(0)) : "}" == l || "]" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_CLOSE_BRACKET, n = l.charCodeAt(0)) : "'" == l || '"' == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_QUOTE, n = l.charCodeAt(0)) : (m = q.charCodeAt(p), n = c.charCodeAt(p));
        if (r) {
          ...
          t = Utils.keyEvent(a, b, "keydown", m, 0, e, r || h, k, d, !1);
          Utils.keyEvent(a, b, "keypress", l, n, e, r || h, k, d, !t);
...
Utils.keyEvent = function(a, b, c, d, e, f, g, h, k, q) {
  ...
  k && (p += a.MODIFIER_META);
  f = 0;
  q && (f += a.KEY_FLAG_PREVENT_DEFAULT);
  return a.sendKeyEvent(c, d, e, p, f);
};
...
Utils.waitForNativeEventsProcessing = function(a, b, c, d) {
  ...
  do {
    ...
    goog.log.info(Utils.LOG_, "Extra events processed: " + k + " Page Unloaded: " + c.wasUnloaded);
...
fxdriver.Request = function(a) {
  this.request_ = a;
  this.attributes_ = {};
};
fxdriver.Request.Method = {DELETE:"DELETE", GET:"GET", HEAD:"HEAD", OPTIONS:"OPTIONS", POST:"POST", PUT:"PUT", TRACE:"TRACE"};
...
fxdriver.Request.prototype.getHeader = function(a) {
  return this.request_.getHeader(a.toLowerCase());
};
fxdriver.Request.prototype.setServletPath = function(a) {
  this.prefix_ = a;
};
...
fxdriver.Request.prototype.getAttribute = function(a) {
...
fxdriver.Request.prototype.setAttribute = function(a, b) {
...
fxdriver.Response = function(a, b) {
  this.response_ = a;
  this.body_ = "";
  this.committed_ = !1;
};
...
fxdriver.Response.StatusMessage_ = {100:"Continue", 200:"OK", 204:"No Content", 303:"See Other", 400:"Bad Request", 404:"Not Found", 405:"Method Not Allowed", 411:"Length Required", 500:"Internal Server Error", 501:"Not Implemented", 505:"HTTP Version Not Supported"};
fxdriver.Response.CRLF = "\r\n";
fxdriver.Response.prototype.status_ = fxdriver.Response.OK;
fxdriver.Response.prototype.setStatus = function(a) {
  this.status_ = a;
  this.response_.setStatusLine(null, a, fxdriver.Response.StatusMessage_[a]);
};
fxdriver.Response.prototype.setHeader = function(a, b) {
  this.response_.setHeader(a, b, !1);
};
fxdriver.Response.prototype.setContentType = function(a) {
  this.setHeader("Content-Type", a + "; charset=UTF-8");
};
fxdriver.Response.prototype.getHeader = function(a) {
  return this.response_.getHeader(a);
};
fxdriver.Response.prototype.setBody = function(a) {
  this.body_ = a.toString();
};
fxdriver.Response.prototype.getBody = function() {
  return this.body_;
};
fxdriver.Response.prototype.sendRedirect = function(a) {
  this.setStatus(fxdriver.Response.SEE_OTHER);
  this.setHeader("Location", a);
  this.commit();
};
fxdriver.Response.prototype.sendError = function(a, b, c) {
  this.setStatus(a);
  this.setBody(b || "");
...
fxdriver.Response.prototype.commit = function() {
  if (this.committed_) {
    var a = ["fxdriver.Response already committed"];
    a.push("response: " + this.status_ + " " + fxdriver.Response.StatusMessage_[this.status_]);
    a.push("          " + this.body_);
    Components.utils.reportError(a.join("\n  "));
  } else {
    this.committed_ = !0;
    var b = (100 > this.status_ || 199 < this.status_) && 204 != this.status_ && 304 != this.status_, c = Components.classes["@mozilla.org/intl/scriptableunicodeconverter"].createInstance(Components.interfaces.nsIScriptableUnicodeConverter);
    c.charset = "UTF-8";
    a = c.convertToByteArray(this.body_, {});
    (100 > this.status_ || 199 < this.status_) && this.setHeader("Connection", "close");
    b && this.setHeader("Content-Length", a.length);
    b && (b = c.convertToInputStream(this.body_), this.response_.bodyOutputStream.writeFrom(b, a.length), this.response_.bodyOutputStream.flush());
...
Dispatcher.notImplemented = function(a, b) {
  b.sendError(fxdriver.Response.NOT_IMPLEMENTED, "Unsupported command", "text/plain");
};
Dispatcher.executeAs = function(a) {
  return function(b, c) {
    for (var d = {name:a, sessionId:b.getAttribute("sessionId"), parameters:JSON.parse(b.getBody() || "{}")}, e = b.getAttributeNames(), f;f = e.shift();) {
      "sessionId" == f || d.parameters[f] || (d.parameters[f] = b.getAttribute(f));
    }
    d = JSON.stringify(d);
    Components.classes["@googlecode.com/webdriver/command-processor;1"].getService(Components.interfaces.nsICommandProcessor).execute(d, function(a) {
      JSON.parse(a).status != bot.ErrorCode.SUCCESS && c.setStatus(fxdriver.Response.INTERNAL_ERROR);
...
Dispatcher.prototype.init_ = function() {
  this.bind_("/config/drivers").on(fxdriver.Request.Method.POST, Dispatcher.notImplemented);
  this.bind_("/status").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getStatus"));
  this.bind_("/session").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("newSession"));
  this.bind_("/session/:sessionId").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getSessionCapabilities")).on(fxdriver.Request.Method.DELETE, Dispatcher.executeAs("quit"));
  this.bind_("/session/:sessionId/window_handle").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getCurrentWindowHandle"));
  this.bind_("/session/:sessionId/window_handles").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getWindowHandles"));
  this.bind_("/session/:sessionId/speed").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getSpeed")).on(fxdriver.Request.Method.POST, Dispatcher.executeAs("setSpeed"));
  this.bind_("/session/:sessionId/timeouts").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("setTimeout"));
  this.bind_("/session/:sessionId/timeouts/implicit_wait").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("implicitlyWait"));
  this.bind_("/session/:sessionId/timeouts/async_script").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("setScriptTimeout"));
  this.bind_("/session/:sessionId/url").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getCurrentUrl")).on(fxdriver.Request.Method.POST, Dispatcher.executeAs("get"));
  this.bind_("/session/:sessionId/accept_alert").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("acceptAlert"));
  this.bind_("/session/:sessionId/dismiss_alert").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("dismissAlert"));
  this.bind_("/session/:sessionId/alert_text").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getAlertText")).on(fxdriver.Request.Method.POST, Dispatcher.executeAs("setAlertValue"));
  this.bind_("/session/:sessionId/forward").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("goForward"));
  this.bind_("/session/:sessionId/back").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("goBack"));
  this.bind_("/session/:sessionId/refresh").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("refresh"));
  this.bind_("/session/:sessionId/execute").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("executeScript"));
  this.bind_("/session/:sessionId/execute_async").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("executeAsyncScript"));
  this.bind_("/session/:sessionId/source").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getPageSource"));
  this.bind_("/session/:sessionId/title").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getTitle"));
  this.bind_("/session/:sessionId/element").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("findElement"));
  this.bind_("/session/:sessionId/elements").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("findElements"));
  this.bind_("/session/:sessionId/element/active").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("getActiveElement"));
  this.bind_("/session/:sessionId/element/:id").on(fxdriver.Request.Method.GET, Dispatcher.notImplemented);
  this.bind_("/session/:sessionId/element/:id/element").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("findChildElement"));
  this.bind_("/session/:sessionId/element/:id/elements").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("findChildElements"));
  this.bind_("/session/:sessionId/element/:id/text").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getElementText"));
  this.bind_("/session/:sessionId/element/:id/submit").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("submitElement"));
  this.bind_("/session/:sessionId/element/:id/value").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("sendKeysToElement"));
  this.bind_("/session/:sessionId/element/:id/name").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getElementTagName"));
  this.bind_("/session/:sessionId/element/:id/clear").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("clearElement"));
  this.bind_("/session/:sessionId/element/:id/selected").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("isElementSelected"));
  this.bind_("/session/:sessionId/element/:id/enabled").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("isElementEnabled"));
  this.bind_("/session/:sessionId/element/:id/displayed").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("isElementDisplayed"));
  this.bind_("/session/:sessionId/element/:id/location").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getElementRect"));
  this.bind_("/session/:sessionId/element/:id/location_in_view").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getElementLocationOnceScrolledIntoView"));
  this.bind_("/session/:sessionId/element/:id/size").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getElementRect"));
  this.bind_("/session/:sessionId/element/:id/rect").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getElementRect"));
  this.bind_("/session/:sessionId/element/:id/css/:propertyName").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getElementValueOfCssProperty"));
  this.bind_("/session/:sessionId/element/:id/attribute/:name").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getElementAttribute"));
  this.bind_("/session/:sessionId/element/:id/equals/:other").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("elementEquals"));
  this.bind_("/session/:sessionId/cookie").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getCookies")).on(fxdriver.Request.Method.POST, Dispatcher.executeAs("addCookie")).on(fxdriver.Request.Method.DELETE, Dispatcher.executeAs("deleteAllCookies"));
  this.bind_("/session/:sessionId/cookie/:name").on(fxdriver.Request.Method.DELETE, Dispatcher.executeAs("deleteCookie"));
  this.bind_("/session/:sessionId/frame").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("switchToFrame"));
  this.bind_("/session/:sessionId/frame/parent").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("switchToParentFrame"));
  this.bind_("/session/:sessionId/window").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("switchToWindow")).on(fxdriver.Request.Method.DELETE, Dispatcher.executeAs("close"));
  this.bind_("/session/:sessionId/window/:windowHandle/size").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("setWindowSize")).on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getWindowSize"));
  this.bind_("/session/:sessionId/window/:windowHandle/position").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("setWindowPosition")).on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getWindowPosition"));
  this.bind_("/session/:sessionId/window/:windowHandle/maximize").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("maximizeWindow"));
  this.bind_("/session/:sessionId/window/:windowHandle/restore").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("restoreWindow"));
  this.bind_("/session/:sessionId/screenshot").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("screenshot"));
  this.bind_("/session/:sessionId/ime/available_engines").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("imeGetAvailableEngines"));
  this.bind_("/session/:sessionId/ime/active_engine").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("imeGetActiveEngine"));
  this.bind_("/session/:sessionId/ime/activated").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("imeIsActivated"));
  this.bind_("/session/:sessionId/ime/deactivate").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("imeDeactivate"));
  this.bind_("/session/:sessionId/ime/activate").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("imeActivateEngine"));
  this.bind_("/session/:sessionId/element/:id/click").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("clickElement"));
  this.bind_("/session/:sessionId/moveto").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("mouseMoveTo"));
  this.bind_("/session/:sessionId/buttondown").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("mouseButtonDown"));
  this.bind_("/session/:sessionId/buttonup").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("mouseButtonUp"));
  this.bind_("/session/:sessionId/click").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("mouseClick"));
  this.bind_("/session/:sessionId/doubleclick").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("mouseDoubleClick"));
  this.bind_("/session/:sessionId/keys").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("sendKeysToActiveElement"));
  this.bind_("/session/:sessionId/log").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("getLog"));
  this.bind_("/session/:sessionId/log/types").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getAvailableLogTypes"));
  this.bind_("/session/:sessionId/application_cache/status").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getAppCacheStatus"));
  this.bind_("/extensions/firefox/quit").on(fxdriver.Request.Method.POST, Dispatcher.executeAs("quit"));
};
Dispatcher.prototype.bind_ = function(a) {
  a = new Resource(a);
  this.resources_.push(a);
  return a;
};
Dispatcher.prototype.dispatch = function(a, b) {
  var c = a.getPathInfo();
  if (0 != c.indexOf("/hub")) {
    b.sendError(fxdriver.Response.NOT_FOUND);
  } else {
    a.setServletPath("/hub");
    for (var c = a.getPathInfo(), d, e = 0;e < this.resources_.length;e++) {
      this.resources_[e].isResourceFor(c) && (!d || d.getNumVariablePathSegments() < this.resources_[e].getNumVariablePathSegments()) && (d = this.resources_[e]);
    }
    if (d) {
      try {
        d.setRequestAttributes(a), d.handle(a, b);
      } catch (f) {
        goog.log.error(this.log_, "Error processing request", f), b.sendError(fxdriver.Response.INTERNAL_ERROR, JSON.stringify({status:bot.ErrorCode.UNKNOWN_ERROR, value:fxdriver.error.toJSON(f)}), "application/json");
      }
    } else {
      b.sendError(fxdriver.Response.NOT_FOUND, "Unrecognized command: " + a.getMethod() + " " + a.getPathInfo(), "text/plain");
    }
  }
};
var Resource = function(a) {
  this.path_ = a;
  this.pathSegments_ = a.split("/");
  this.handlers_ = {};
  for (a = 0;a < this.pathSegments_.length;a++) {
    this.pathSegments_[a].indexOf(Resource.VARIABLE_PATH_SEGMENT_PREFIX_) && (this.numVariablePathSegments_ += 1);
  }
};
...
Resource.prototype.on = function(a, b) {
  this.handlers_[a] = b;
  return this;
};
Resource.prototype.isResourceFor = function(a) {
  a = a.split("/");
  if (this.pathSegments_.length != a.length) {
    return!1;
  }
  for (var b = 0;b < this.pathSegments_.length;b++) {
    if (this.pathSegments_[b] != a[b] && !/^:/.test(this.pathSegments_[b])) {
      return!1;
    }
  }
  return!0;
};
Resource.prototype.setRequestAttributes = function(a) {
  for (var b = a.getPathInfo().split("/"), c = 0;c < this.pathSegments_.length;c++) {
    if (/^:/.test(this.pathSegments_[c])) {
      var d = decodeURIComponent(b[c]);
      a.setAttribute(this.pathSegments_[c].replace(/^:/, ""), d);
    }
  }
};
Resource.prototype.handle = function(a, b) {
  if (!this.isResourceFor(a.getPathInfo())) {
    throw Error("Request does not map to this resource:\n  requestPath:  " + a.getPathInfo() + "\n  resourcePath: " + this.path_);
  }
  var c = a.getMethod();
  c == fxdriver.Request.Method.OPTIONS ? (b.setHeader("Allow", this.getAllowedMethods_()), b.setStatus(fxdriver.Response.OK), b.setBody(""), b.commit()) : (c == fxdriver.Request.Method.HEAD && (c = fxdriver.Request.Method.GET), (c = this.handlers_[c]) ? c(a, b) : (b.setHeader("Allow", this.getAllowedMethods_()), b.setContentType("text/plain"), b.sendError(fxdriver.Response.METHOD_NOT_ALLOWED, 'Method "' + a.getMethod() + '" not allowed for command "' + this.path_ + '"')));
};
Resource.prototype.getAllowedMethods_ = function() {
  var a = [], b;
  for (b in this.handlers_) {
    a.push(b);
  }
  a.push(fxdriver.Request.Method.OPTIONS);
  fxdriver.Request.Method.GET in this.handlers_ && a.push(fxdriver.Request.Method.HEAD);
  return a.join(",");
};
bot.html5 = {};
...
bot.events.TouchEventFactory_.prototype.create = function(a, b) {
  ...
  var f = goog.dom.getOwnerDocument(a), g = goog.dom.getWindow(f), h = e(b.changedTouches), k = b.touches == b.changedTouches ? h : e(b.touches), q = b.targetTouches == b.changedTouches ? h : e(b.targetTouches), p;
  bot.events.BROKEN_TOUCH_API_ ? (p = f.createEvent("MouseEvents"), p.initMouseEvent(this.type_, this.bubbles_, this.cancelable_, g, 1, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, 0, b.relatedTarget), p.touches = k, p.targetTouches = q, p.changedTouches = h, p.scale = b.scale, p.rotation = b.rotation) : (p = f.createEvent("TouchEvent"), goog.userAgent.product.ANDROID ? p.initTouchEvent(k, q, h, this.type_, g, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, 
  b.metaKey) : p.initTouchEvent(this.type_, this.bubbles_, this.cancelable_, g, 1, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, k, q, h, b.scale, b.rotation), p.relatedTarget = b.relatedTarget);
  return p;
};
...
bot.window.scrollIntoView = function(a, b) {
  ...
  var d = b || bot.getWindow(), e = goog.dom.getViewportSize(d), f = bot.window.getScroll(d), e = new goog.math.Coordinate(c(a.x, f.x, e.width), c(a.y, f.y, e.height));
...
fxdriver.events.buildCoordinates = function(a, b) {
  var c = a.element ? Utils.getElementAt(a.element, b) : null, d = "xoffset" in a ? a.xoffset : null, e = "yoffset" in a ? a.yoffset : null;
...
fxdriver.screenshot.toBase64 = function(a) {
  ...
  try {
    ...
    throw Error("Unable to get data from base64 string - " + d);
  }
};
...
var FirefoxDriver = function(a, b, c, d) {
  this.server = a;
  this.enableNativeEvents = b;
  this.window = c;
  this.pageLoadStrategy = d || "normal";
...
FirefoxDriver.prototype.getCurrentUrl = function(a) {
  var b = a.session.getWindow(), c;
  b && (c = b.location);
  c || (c = a.session.getBrowser().contentWindow.location);
  a.value = "" + c;
  a.send();
};
FirefoxDriver.prototype.get = function(a, b) {
  var c = b.url, d = a.session.getWindow().location, e;
  try {
    e = fxdriver.io.isLoadExpected(d, c);
  } catch (f) {
    if (d = f.QueryInterface(Components.interfaces.nsIException), "NS_ERROR_MALFORMED_URI" == d.name) {
      goog.log.warning(FirefoxDriver.LOG_, d.name);
      a.sendError(new WebDriverError(bot.ErrorCode.UNKNOWN_ERROR, "Target URL " + c + " is not well-formed."));
      return;
    }
  }
  e && Utils.initWebLoadingListener(a, a.session.getWindow());
  a.session.getBrowser().loadURI(c);
  e || (goog.log.info(FirefoxDriver.LOG_, "No load event expected"), a.send());
};
FirefoxDriver.prototype.close = function(a) {
  ...
  if (1 == e) {
    a.send(), FirefoxDriver.nstimer = new fxdriver.Timer, FirefoxDriver.nstimer.setTimeout(function(a) {
      notifyOfCloseWindow();
      c.quit(d);
    }, 500);
  } else {
...
function injectAndExecuteScript(a, b, c, d) {
  var e = a.session.getDocument(), f = fxdriver.moz.unwrap(e), g = b.script, h = Utils.unwrapParameters(b.args, e);
  if (e.designMode && "on" == e.designMode.toLowerCase()) {
    ...
    goog.log.info(FirefoxDriver.LOG_, "Window in design mode, falling back to sandbox: " + e.designMode);
    var k = a.session.getWindow(), k = k.wrappedJSObject, q = new Components.utils.Sandbox(k);
    q.window = k;
    q.document = e.wrappedJSObject ? e.wrappedJSObject : e;
    q.navigator = k.navigator;
    try {
      q.__webdriverParams = cloneInto(h, q);
      var p = Components.utils.evalInSandbox("with(window) { var __webdriverFunc = function(){" + b.script + "};  __webdriverFunc.apply(null, __webdriverParams); }", q);
      a.value = Utils.wrapResult(p, e);
      a.send();
      return;
    } catch (l) {
      throw new WebDriverError(bot.ErrorCode.JAVASCRIPT_ERROR, l);
    }
  }
  var r = this, n = function() {
    r.modalOpen || a.sendError(new WebDriverError(bot.ErrorCode.JAVASCRIPT_ERROR, "waiting for evaluate.js load failed"));
  }, m = function() {
    return f.__webdriver_evaluate && !!f.__webdriver_evaluate.attached;
  }, t = function() {
    ...
    f.__webdriver_evaluate.args = cloneInto(h, f.__webdriver_evaluate);
    f.__webdriver_evaluate.async = c;
    f.__webdriver_evaluate.script = g;
    f.__webdriver_evaluate.timeout = a.session.getScriptTimeout();
    var b = function(c) {
      e.removeEventListener("webdriver-evaluate-response", b, !0);
      r.modalOpen || (a.value = Utils.wrapResult(f.__webdriver_evaluate.result, e), a.status = f.__webdriver_evaluate.code, bot.userAgent.isProductVersion(23) || delete f.__webdriver_evaluate, a.send());
    };
  ...
  d.runWhenTrue(function() {
    return!!Utils.getMainDocumentElement(e);
  }, function() {
    if (!e.__webdriver_evaluate || !e.__webdriver_evaluate.attached) {
      var a = Utils.getMainDocumentElement(e), b = Utils.isSVG(e) ? e.createElementNS("http://www.w3.org/2000/svg", "script") : e.createElement("script");
      b.setAttribute("type", "text/javascript");
      b.textContent = FirefoxDriver.listenerScript;
      a.appendChild(b);
      a.removeChild(b);
    }
    d.runWhenTrue(m, t, 1E4, n);
  }, 1E4, function() {
    r.modalOpen || a.sendError(new WebDriverError(bot.ErrorCode.JAVASCRIPT_ERROR, "waiting for doc.body failed"));
  });
}
...
FirefoxDriver.prototype.findElementInternal_ = function(a, b, c, d, e) {
  e = goog.isNumber(e) ? e : goog.now();
  var f = a.session.getDocument();
  try {
    var g = goog.isString(d) ? Utils.getElementAt(d, f) : f, f = {};
    f[b] = c;
    var h = bot.locators.findElement(f, g);
    if (h) {
      var k = Utils.addToKnownElements(h);
      a.value = {ELEMENT:k, "element-6066-11e4-a52e-4f735466cecf":k};
      return a.send();
    }
    var q = a.session.getImplicitWait();
    if (0 == q || goog.now() - e > q) {
    ...
    var p = goog.bind(this.findElementInternal_, this, a, b, c, d, e);
    this.jsTimer.setTimeout(p, 100);
  } catch (l) {
...
FirefoxDriver.prototype.findElementsInternal_ = function(a, b, c, d, e) {
  ...
  try {
    ...
    for (var h = bot.locators.findElements(f, g), g = [], f = 0;f < h.length;f++) {
      var k = Utils.addToKnownElements(h[f]);
      g.push({ELEMENT:k, "element-6066-11e4-a52e-4f735466cecf":k});
    }
    var q = a.session.getImplicitWait();
    if (q && !h.length && goog.now() - e <= q) {
      var p = goog.bind(this.findElementsInternal_, this, a, b, c, d, e);
      this.jsTimer.setTimeout(p, 10);
    } else {
      a.value = g, a.send();
    }
  } catch (l) {
...
FirefoxDriver.prototype.switchToFrame = function(a, b) {
  ...
  var e = null;
  if (d) {
    goog.log.info(FirefoxDriver.LOG_, "Switching to default content (topmost frame)"), e = a.session.getBrowser().contentWindow;
  } else {
    if (goog.isString(b.id)) {
      goog.log.info(FirefoxDriver.LOG_, "Switching to frame with name or ID: " + b.id), e = bot.frame.findFrameByNameOrId(b.id, c);
    } else {
      if (goog.isNumber(b.id)) {
        goog.log.info(FirefoxDriver.LOG_, "Switching to frame by index: " + b.id), e = bot.frame.findFrameByIndex(b.id, c);
      } else {
  ...
  if (e) {
    e.frameElement ? (a.session.setWindow(e), a.session.setFrame(e.frameElement)) : a.session.setWindow(e), a.send();
  } else {
...
FirefoxDriver.prototype.addCookie = function(a, b) {
  ...
  fxdriver.moz.getService("@mozilla.org/cookiemanager;1", "nsICookieManager2").add(c.domain, c.path, c.name, c.value, c.secure, !1, d, c.expiry);
  a.send();
};
...
FirefoxDriver.prototype.deleteCookie = function(a, b) {
  for (var c = b.name, d = fxdriver.moz.getService("@mozilla.org/cookiemanager;1", "nsICookieManager"), e = getVisibleCookies(a.session.getWindow().location), f = 0;f < e.length;f++) {
    var g = e[f];
...
FirefoxDriver.prototype.screenshot = function(a) {
  ...
  try {
    ...
    throw new WebDriverError(bot.ErrorCode.UNKNOWN_ERROR, "Could not convert screenshot to base64 - " + e);
  }
  a.send();
};
FirefoxDriver.prototype.getAlert = function(a) {
  fxdriver.modals.isModalPresent(function(b) {
    b || (a.status = bot.ErrorCode.NO_SUCH_ALERT, a.value = {message:"No alert is present"});
    a.send();
  }, this.alertTimeout);
};
...
function getElementFromLocation(a, b) {
  ...
  a.initialized ? (c = b.elementFromPoint(d, e), goog.log.info(FirefoxDriver.LOG_, "Element from (" + d + "," + e + ") :" + c)) : (goog.log.info(FirefoxDriver.LOG_, "Mouse coordinates were not set - using body"), c = b.getElementsByTagName("body")[0]);
  return fxdriver.moz.unwrap(c);
}
function generateErrorForNativeEvents(a, b, c) {
...
FirefoxDriver.prototype.mouseMoveTo = function(a, b) {
  var c = a.session.getDocument(), d = fxdriver.events.buildCoordinates(b, c);
  if (d.auxiliary) {
    var e = new goog.math.Coordinate(d.x, d.y);
    if (!bot.action.scrollIntoView(d.auxiliary, e) && !Utils.isSVG(d.auxiliary.ownerDocument) && !bot.dom.isElement(d.auxiliary, goog.dom.TagName.OPTION)) {
      a.sendError(new WebDriverError(bot.ErrorCode.MOVE_TARGET_OUT_OF_BOUNDS, "Offset within element cannot be scrolled into view: " + e + ": " + d.auxiliary));
      return;
    }
  }
  if (this.enableNativeEvents) {
    a: {
      c = this.jsTimer;
      goog.log.info(FirefoxDriver.LOG_, "Calling native move with: " + d.x + ", " + d.y);
      var e = null, f;
      d.auxiliary ? (e = fxdriver.moz.unwrap(d.auxiliary), f = Utils.getLocationRelativeToWindowHandle(e)) : (e = getElementFromLocation(a.session.getMousePosition(), a.session.getTopDocument()), f = a.session.getMousePosition());
      f.x = Math.floor(f.x + d.x);
      f.y = Math.floor(f.y + d.y);
      var g;
      try {
        var d = f, h = a.session.getTopWindow(), k = bot.window.getScroll(h), q = goog.math.Coordinate.sum(k, d);
        bot.window.scrollIntoView(q, h);
        var p = bot.window.getScroll(h);
        g = goog.math.Coordinate.difference(q, p);
      } catch (l) {
        if (l.code == bot.ErrorCode.MOVE_TARGET_OUT_OF_BOUNDS) {
          a.sendError(new WebDriverError(bot.ErrorCode.MOVE_TARGET_OUT_OF_BOUNDS, "Given coordinates (" + f.x + ", " + f.y + ") are outside the document. Error: " + l));
          break a;
        }
        throw l;
      }
      var q = (d = a.session.isMousePressed()) ? f : g, k = Utils.getBrowserSpecificOffset(a.session.getBrowser()), h = q.x + k.x, q = q.y + k.y, p = Utils.getNativeMouse(), r = Utils.getNodeForNativeEvents(e);
      if (p && r) {
        var n = a.session.getMousePosition(), m = n.x + k.x, k = n.y + k.y;
        goog.log.info(FirefoxDriver.LOG_, "Moving from (" + n.x + ", " + n.y + ") to (" + g.x + ", " + g.y + ")");
        p.mouseMove(r, m, k, h, q);
        Utils.waitForNativeEventsProcessing(e, Utils.getNativeEvents(), {wasUnloaded:!1}, c);
        a.session.setMousePosition(g.x, g.y);
        d && a.session.setMouseViewportOffset(f.x, f.y);
      } else {
        throw generateErrorForNativeEvents(!0, p, r);
      }
    }
    a.send();
  } else {
    g = d.auxiliary || c, goog.log.info(FirefoxDriver.LOG_, "Calling move with: " + d.x + ", " + d.y + ", " + g), g = this.mouse.move(g, d.x, d.y), this.sendResponseFromSyntheticMouse_(g, a);
  }
};
FirefoxDriver.prototype.mouseButtonDown = function(a, b) {
  var c = a.session.getDocument();
  if (this.enableNativeEvents) {
    var c = getElementFromLocation(a.session.getMousePosition(), a.session.getTopDocument()), d = Utils.getNativeMouse(), e = Utils.getNodeForNativeEvents(c);
    if (d && e) {
      var f = a.session.getMousePosition(), g = Utils.getBrowserSpecificOffset(a.session.getBrowser());
      d.mousePress(e, f.x + g.x, f.y + g.y, 1);
      Utils.waitForNativeEventsProcessing(c, Utils.getNativeEvents(), {wasUnloaded:!1}, this.jsTimer);
      a.session.setMousePressed(!0);
      a.session.setMouseViewportOffset(f.x, f.y);
    } else {
      throw generateErrorForNativeEvents(this.enableNativeEvents, d, e);
    }
    a.send();
  } else {
    c = fxdriver.events.buildCoordinates(b, c), goog.log.info(FirefoxDriver.LOG_, "Calling down with: " + c.x + ", " + c.y + ", " + c.auxiliary), c = this.mouse.down(c), this.sendResponseFromSyntheticMouse_(c, a);
  }
};
FirefoxDriver.prototype.mouseButtonUp = function(a, b) {
  ...
  if (this.enableNativeEvents) {
    var c = getElementFromLocation(a.session.getMousePosition(), a.session.getTopDocument()), d = Utils.getNativeMouse(), e = Utils.getNodeForNativeEvents(c);
    if (this.enableNativeEvents && d && e) {
      var f = a.session.getMousePosition(), g = f.x, h = f.y;
      a.session.isMousePressed() && (g = f.viewPortXOffset, h = f.viewPortYOffset, goog.log.info(FirefoxDriver.LOG_, "Button pressed. Using coordiantes with viewport offset: " + g + ", " + h));
      f = Utils.getBrowserSpecificOffset(a.session.getBrowser());
      d.mouseRelease(e, g + f.x, h + f.y, 1);
      Utils.waitForNativeEventsProcessing(c, Utils.getNativeEvents(), {wasUnloaded:!1}, this.jsTimer);
    ...
    c = fxdriver.events.buildCoordinates(b, c), goog.log.info(FirefoxDriver.LOG_, "Calling up with: " + c.x + ", " + c.y + ", " + c.auxiliary), c = this.mouse.up(c), this.sendResponseFromSyntheticMouse_(c, a);
  }
};
FirefoxDriver.prototype.mouseClick = function(a, b) {
  ...
  var c = b.button;
  if (this.enableNativeEvents) {
    a.session.getDocument();
    var d = getElementFromLocation(a.session.getMousePosition(), a.session.getTopDocument()), e = Utils.getNativeMouse(), f = Utils.getNodeForNativeEvents(d);
    if (this.enableNativeEvents && e && f) {
      var g = a.session.getMousePosition(), h = Utils.getBrowserSpecificOffset(a.session.getBrowser());
      e.click(f, g.x + h.x, g.y + h.y, c);
      Utils.waitForNativeEventsProcessing(d, Utils.getNativeEvents(), {wasUnloaded:!1}, this.jsTimer);
      bot.dom.isEditable(d) && void 0 !== d.value && goog.dom.selection.setCursorPosition(d, d.value.length);
    } else {
      throw generateErrorForNativeEvents(this.enableNativeEvents, e, f);
    }
    a.send();
  } else {
    c = 2 == c ? this.mouse.contextClick(null) : this.mouse.click(null), this.sendResponseFromSyntheticMouse_(c, a);
  }
};
FirefoxDriver.prototype.mouseDoubleClick = function(a, b) {
  ...
  Utils.installClickListener(a, WebLoadingListener);
  if (this.enableNativeEvents) {
    var c = a.session.getDocument(), c = getElementFromLocation(a.session.getMousePosition(), c), d = Utils.getNativeMouse(), e = Utils.getNodeForNativeEvents(c);
    if (this.enableNativeEvents && d && e) {
      var f = a.session.getMousePosition(), g = Utils.getBrowserSpecificOffset(a.session.getBrowser());
      d.doubleClick(e, f.x + g.x, f.y + g.y);
      Utils.waitForNativeEventsProcessing(c, Utils.getNativeEvents(), {wasUnloaded:!1}, this.jsTimer);
    } else {
      throw generateErrorForNativeEvents(this.enableNativeEvents, d, e);
    }
    ...
    c = this.mouse.doubleClick(null), this.sendResponseFromSyntheticMouse_(c, a);
  }
};
FirefoxDriver.prototype.sendKeysToActiveElement = function(a, b) {
  ...
  Utils.type(a.session.getDocument(), c, b.value.join(""), this.enableNativeEvents, this.jsTimer, !1, this.modifierKeysState);
  a.send();
};
FirefoxDriver.prototype.getWindowSize = function(a, b) {
  this.assertTargetsCurrentWindow_(b);
  var c = bot.window.getSize(a.session.getWindow().top);
  a.value = {width:c.width, height:c.height};
  a.send();
};
FirefoxDriver.prototype.setWindowSize = function(a, b) {
  this.assertTargetsCurrentWindow_(b);
  var c = new goog.math.Size(b.width, b.height), d = a.session.getWindow().top;
  bot.window.setSize(c, d);
  a.send();
};
FirefoxDriver.prototype.getWindowPosition = function(a, b) {
  this.assertTargetsCurrentWindow_(b);
  var c = bot.window.getPosition(a.session.getWindow().top);
  a.value = {x:c.x, y:c.y};
  a.send();
};
FirefoxDriver.prototype.setWindowPosition = function(a, b) {
  this.assertTargetsCurrentWindow_(b);
  var c = new goog.math.Coordinate(b.x, b.y), d = a.session.getWindow().top;
  bot.window.setPosition(c, d);
  a.send();
};
FirefoxDriver.prototype.maximizeWindow = function(a, b) {
  this.assertTargetsCurrentWindow_(b);
  var c = a.session.getWindow();
  this.getChromeWindowFromDocumentWindow(c).maximize();
  a.send();
};
...
bot.action.drag = function(a, b, c, d, e, f) {
  ...
  for (var h = 1;h <= d;h++) {
    var k = Math.floor(h * b / d), q = Math.floor(h * c / d), p = bot.dom.getClientRect(a), k = new goog.math.Coordinate(e.x + g.left + k - p.left, e.y + g.top + q - p.top);
    f.move(a, k);
  }
  f.releaseButton();
};
...
WebElement.clickElement = function(a, b) {
  var c = Utils.getElementAt(b.id, a.session.getDocument()), d = fxdriver.moz.unwrapFor4(c), e = Utils.getNativeMouse(), f = Utils.getNodeForNativeEvents(d), g = Components.classes["@mozilla.org/xre/app-info;1"].getService(Components.interfaces.nsIXULAppInfo), h = 0 <= Components.classes["@mozilla.org/xpcom/version-comparator;1"].getService(Components.interfaces.nsIVersionComparator).compare(g.platformVersion, "1.9"), k = Components.classes["@mozilla.org/thread-manager;1"], q = "option" == d.tagName.toLowerCase(), 
  p = Utils.getLocation(d, "A" == d.tagName), g = p.width ? Math.floor(p.width / 2) : 0, l = p.height ? Math.floor(p.height / 2) : 0;
  if (!q && this.enableNativeEvents && e && f && h && k) {
    goog.log.info(WebElement.LOG_, "Using native events for click");
    p = Utils.scrollIntoView(d, 0 == a.session.elementScrollBehavior, new goog.math.Coordinate(g, l));
    if (!Utils.isSVG(c.ownerDocument) && !p) {
      a.sendError(new WebDriverError(bot.ErrorCode.MOVE_TARGET_OUT_OF_BOUNDS, "Element cannot be scrolled into view:" + c));
      return;
    }
    p = Utils.getLocationRelativeToWindowHandle(d, "A" == d.tagName);
    h = p.x + g;
    p = p.y + l;
    try {
      var r = a.session.getMousePosition(), n = new goog.math.Coordinate(h, p), m = Utils.getBrowserSpecificOffset(a.session.getBrowser());
      e.mouseMove(f, r.x + m.x, r.y + m.y, n.x + m.x, n.y + m.y);
      var t = Utils.getPageUnloadedIndicator(d);
      e.click(f, n.x + m.x, n.y + m.y, 1);
      a.session.setMousePosition(n.x, n.y);
      Utils.waitForNativeEventsProcessing(d, Utils.getNativeEvents(), t, this.jsTimer);
      a.send();
      return;
    } catch (u) {
      if (goog.log.info(WebElement.LOG_, "Detected error when clicking", u), "NS_ERROR_NOT_IMPLEMENTED" != u.name) {
        throw new WebDriverError(bot.ErrorCode.INVALID_ELEMENT_STATE, u);
      }
    }
  }
...
WebElement.getElementText = function(a, b) {
  ...
  a.value = webdriver.atoms.element.getText(c);
  a.send();
};
WebElement.sendKeysToElement = function(a, b) {
  ...
  f != c || d != new XPCNativeWrapper(g) ? (goog.log.info(WebElement.LOG_, "Need to switch focus"), e = !1, f.blur(), c.focus(), c.ownerDocument.defaultView.focus()) : goog.log.info(WebElement.LOG_, "No need to switch focus");
  var h = c;
  ...
  this.jsTimer.setTimeout(function() {
    ...
    try {
      Utils.type(a.session.getDocument(), h, b.value.join(""), k.enableNativeEvents, k.jsTimer, !0), a.send();
    } catch (f) {
      a.sendError(f);
    }
  }, 0);
...
WebElement.submitElement = function(a, b) {
  ...
  if (c) {
    ...
    if (c.tagName && "form" == c.tagName.toLowerCase()) {
      var d = a.session.getWindow().location;
      Utils.fireHtmlEvent(c, "submit") && fxdriver.io.isLoadExpected(d, c.action) ? (new WebLoadingListener(a.session.getBrowser(), function(b) {
...
WebElement.getElementRect = function(a, b) {
  var c = Utils.getElementAt(b.id, a.session.getDocument()), d = a.session.getWindow(), c = Utils.getLocation(c);
  a.value = {x:Math.round(c.x + d.pageXOffset), y:Math.round(c.y + d.pageYOffset), width:Math.round(c.width), height:Math.round(c.height)};
  a.send();
};
...
WebElement.getElementLocationOnceScrolledIntoView = function(a, b) {
  var c = Utils.getElementAt(b.id, a.session.getDocument());
  Utils.getMainDocumentElement(c.ownerDocument).focus();
  c = Utils.getLocationOnceScrolledIntoView(c, 0 == a.session.elementScrollBehavior);
  a.value = {x:Math.round(c.x), y:Math.round(c.y)};
  a.send();
};
var WebDriverServer = function() {
  ...
  Components.classes["@mozilla.org/security/certoverride;1"].getService(Components.interfaces.nsICertOverrideService);
  var a = new Dispatcher;
  try {
    this.server_ = Utils.newInstance("@mozilla.org/server/jshttp;1", "nsIHttpServer");
  } catch (b) {
    goog.log.warning(WebDriverServer.LOG_, "Failed to create HTTP server", b);
  }
  this.server_.registerPrefixHandler("/hub/", {handle:function(b, d) {
    d.processAsync();
    a.dispatch(new fxdriver.Request(b), new fxdriver.Response(d));
  }});
};
WebDriverServer.LOG_ = fxdriver.logging.getLogger("fxdriver.WebDriverServer");
WebDriverServer.prototype.newDriver = function(a) {
  this.enableNativeEvents || (this.enableNativeEvents = Utils.useNativeEvents(), goog.log.info(WebDriverServer.LOG_, "Using native events: " + this.enableNativeEvents));
  a.fxdriver = new FirefoxDriver(this, this.enableNativeEvents, a);
  return a.fxdriver;
};
WebDriverServer.prototype.getNextId = function() {
  return this.generator.generateUUID().toString();
};
WebDriverServer.prototype.startListening = function(a) {
  if (!a) {
    var b = fxdriver.moz.getService("@mozilla.org/preferences-service;1", "nsIPrefBranch");
    a = b.prefHasUserValue("webdriver_firefox_port") ? b.getIntPref("webdriver_firefox_port") : 7055;
  }
  if (!this.isListening) {
    this.server_.start(a);
    if (b.prefHasUserValue("webdriver_firefox_allowed_hosts")) {
      var b = b.getCharPref("webdriver_firefox_allowed_hosts").split(","), c;
      for (c in b) {
        this.server_.identity.add("http", b[c], a);
      }
    }
    this.isListening = !0;
  }
};
WebDriverServer.prototype.QueryInterface = function(a) {
  if (!a.equals(nsISupports)) {
    throw Components.results.NS_ERROR_NO_INTERFACE;
  }
  return this;
};
WebDriverServer.prototype.createInstance = function(a, b, c) {
  a = WebDriverServer.readPort();
  this.startListening(a);
};
var nsISupports = Components.interfaces.nsISupports, CLASS_ID = Components.ID("{1C0E8D86-B661-40d0-AE3D-CA012FADF170}"), CLASS_NAME = "firefoxWebDriver", CONTRACT_ID = "@googlecode.com/webdriver/fxdriver;1", LOG_ = fxdriver.logging.getLogger("fxdriver.ServerFactory"), ServerFactory = {createInstance:function(a, b) {
  Components.utils.import("resource://gre/modules/AddonManager.jsm");
  AddonManager.getAddonByID("fxdriver@googlecode.com", function(a) {
    goog.log.info(LOG_, "Driven by WebDriver version " + a.version);
  });
  if (null != a) {
    throw Components.results.NS_ERROR_NO_AGGREGATION;
  }
  this.server || (this.server = new WebDriverServer);
  return this.server.QueryInterface(b);
}}, ServerModule = {firstTime_:!0, registerSelf:function(a, b, c, d) {
  if (this.firstTime_) {
    throw this.firstTime_ = !1, Components.results.NS_ERROR_FACTORY_REGISTER_AGAIN;
  }
  a = a.QueryInterface(Components.interfaces.nsIComponentRegistrar);
  a.registerFactoryLocation(CLASS_ID, CLASS_NAME, CONTRACT_ID, b, c, d);
}, unregisterSelf:function(a, b, c) {
  a = a.QueryInterface(Components.interfaces.nsIComponentRegistrar);
  a.unregisterFactoryLocation(CLASS_ID, b);
}, getClassObject:function(a, b, c) {
  if (!c.equals(Components.interfaces.nsIFactory)) {
    throw Components.results.NS_ERROR_NOT_IMPLEMENTED;
  }
  if (b.equals(CLASS_ID)) {
    return ServerFactory;
  }
  throw Components.results.NS_ERROR_NO_INTERFACE;
}, canUnload:function(a) {
  return!0;
}};
